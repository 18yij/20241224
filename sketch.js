...
function preload() {
  ...
  sprites.player1.attack.img = loadImage('attack.png');
  sprites.player1.jump.img = loadImage('jump.png');
  
  // 載入玩家2的圖片
  sprites.player2.idle_2.img = loadImage('idle_2.png');
  sprites.player2.attack_2.img = loadImage('attack_2.png');
  sprites.player2.jump_2.img = loadImage('jump_2.png');
}
